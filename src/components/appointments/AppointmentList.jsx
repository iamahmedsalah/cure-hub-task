...
function AppointmentList({ appointments }) {
  ...
  return (
    <div className="bg-base-100 rounded-[8px] transition-colors duration-200 mb-3 h-[805px]   ">
      <div className="overflow-x-auto pt-7 px-7 ">
        <div className="overflow-x-auto ">
          <table className="min-w-full  ">
            <thead className='bg-secondary text-white'>
              <tr>
                <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider rounded-tl-[8px] rounded-bl-[8px]">
                  Patient Name
                </th>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider rounded-tr-[8px] rounded-br-[8px]">
                  Action
                </th>
              </tr>
            </thead>
            ...
            <tbody className="divide-y divide-gray-700">
              {currentAppointments.map((appointment) => (
                ...
                >
                  ...
                  <td className="px-6 py-4  whitespace-nowrap">
                    <span
                      className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${appointment.status === "approved"
            ...
            <div className="flex justify-center mt-3 mb-3">
                {Array.from({ length: totalPages }, (_, index) => (
                    <button
                        ...
                        className={`px-4 py-2 mx-1 rounded-[8px] cursor-pointer ${currentPage === index + 1
